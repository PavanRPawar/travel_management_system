...
public class CheckHotels extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel", "Four Seasons Hotel", "Madarin Oriental Hotel", "Raddisson Blue Hotel", "Classic Hotel", "The Bay Club Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel", "Taj Lake Palace"};
        try {
            for(int i = 0; i <= 9; i++) {
