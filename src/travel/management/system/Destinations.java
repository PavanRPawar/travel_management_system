...
public class Destinations extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classic Hotel", "The Bay Club Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel"};
        try {
            for(int i = 0; i < 9; i++) {
